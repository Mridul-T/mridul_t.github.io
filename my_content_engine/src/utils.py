...
# Build prompt
template = """Use the following pieces of context to answer the question at the end. If you don't know the answer, just say that you don't know, don't try to make up an answer and don't start making up random questions and answers. Keep the answer as concise as possible. Always say "thanks for asking! BBYE!!" at the end of the answer. Once you have said, "thanks for asking" stop generating the answers and exit.
{context}
Question: {question}
Answer: """
QA_CHAIN_PROMPT = PromptTemplate.from_template(template)# Run chain

n_gpu_layers = 10  # Change accordint to your GPU VRAM.
